...
/// <summary>
/// Finds an element inside the array </summary>
/// <param name="d">The dynamic array.</param>
...
/// <summary>
/// Removes an element from the dynamic array </summary>
/// <param name="d">The dynamic array.</param>
...
/// <summary>
/// Modifies an element from the array </summary>
/// <param name="arr">The dynamic array.</param>
...
void hard_copy(DynamicArray *dest, DynamicArray *src);
